...
int main()
{
    ...
    */
    ...
    int mohsin;   // This is variable declaration
    mohsinName = 76;  // This is variable initialization
   ...
   */
    ...
    int hyInput;
    printf("\n Please enter the value of ryInput");
    // scanf("%d", &hyInput);
    // printf("\n You Entered %f as hyInput", (float) hyInput);
